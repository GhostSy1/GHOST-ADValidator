...
VERSION = "2.0.0"
PROFILE = "Active Directory configuration export review"
RULES = [('AD-TRUST', 'trust direction|sidHistory|forest trust'), ('AD-DELEGATION', 'unconstrained delegation|constrained delegation|resource-based'), ('AD-PRIVILEGE', 'adminCount|domain admins|enterprise admins')]
...
def render_banner() -> None:
 ...
 | |__| | | | | |__| | |__| || |_
  \_____|_| |_|\____/ \____/_____|
      GHOST-ADValidator v2.0-PRO (Zero-Guessing Engine)
"""
    print(banner)
