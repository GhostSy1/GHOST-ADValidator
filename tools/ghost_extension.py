...
VERSION = "3.0-PRO"
PROFILE = "Active Directory configuration and trust evaluation"
RULES = [('AD-TRUST', 'sidHistory|forest trust|external trust|selective authentication'), ('AD-DELEGATION', 'unconstrained delegation|constrained delegation|resource-based'), ('AD-PRIV', 'adminCount|domain admins|enterprise admins')]
...
def render_banner() -> None:
 ...
 | |__| | | | | |__| | |__| || |_
  \\_____|_| |_|\\____/ \\____/_____|
      GHOST-ADValidator v3.0-PRO (Zero-Guessing Engine)
"""
    print(banner)
